...
class RequestService
  ...
  def approve_request
    if @req.attendance?
      ...
      attendance_params[:working_hours] = AttendanceService.count_working_hours(@user.company, @req.attended_at || @attendance.attended_at, @req.left_at || @attendance.left_at, @attendance)
