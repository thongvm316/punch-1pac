...
const router = new Router({
  ...
  routes: [
    ...
    { path: '/settings/profile', name: 'user-settings-profile', component: lazyLoadRoute('UserSettingsProfile'), meta: { title: `User Settings Profile - ${appName}` } },
    { path: '/settings/password', name: 'user-settings-password', component: lazyLoadRoute('UserSettingsPassword'), meta: { title: `User Settings Password - ${appName}` } },
    { path: '/settings/security', name: 'user-settings-security', component: lazyLoadRoute('UserSettingsSecurity'), meta: { title: `User Settings Security - ${appName}` } },
