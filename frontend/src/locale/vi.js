export default {
  group: {
    ...
    confirmDialog: {
      ...
      removeUserMsg: 'Bạn có chắc chắn xoá <span class="text-bold-600">{name}</span> ra khỏi nhóm?',
  ...
  validation: {
    ...
    minLength: '{name} is too short (minimum is {length} characters)',
    maxLength: '{name} is too long (maximum is {length} characters)',
