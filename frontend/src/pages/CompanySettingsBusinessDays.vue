  ...
  <setting-layout sidebar-type="company" :title="$t('company.title')" :subtitle="$t('company.businessDays.title')">
    ...
    <table class="table bg-light mt-5">
      <thead>
        ...
        <th>{{ $t('company.businessDays.tableHeader.morningStartAt') }}</th>
        <th>{{ $t('company.businessDays.tableHeader.morningEndAt') }}</th>
        <th>{{ $t('company.businessDays.tableHeader.afternoonStartAt') }}</th>
        <th>{{ $t('company.businessDays.tableHeader.afternoonEndAt') }}</th>
      ...
      <tbody>
        <tr v-for="businessDay in businessDays" :key="businessDay.id">
          ...
          <td>
            ...
            <button class="btn btn-action btn-link tooltip" :data-tooltip="$t('company.businessDays.tooltip.delete')" @click="localDeleteBusinessDay(businessDay)">
