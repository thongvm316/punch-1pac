<template>
  <div>
    ...
    <table class="table bg-light mt-5">
      ...
      <tbody>
        <tr v-for="businessDay in businessDays" :key="businessDay.id">
          ...
          <td>
            <button class="btn btn-action btn-link tooltip" :data-tooltip="$t('tooltip.businessDays.edit')" @click="toggleEditModal(businessDay)">
            ...
            <button class="btn btn-action btn-link tooltip" :data-tooltip="$t('tooltip.businessDays.delete')" @click="localDeleteBusinessDay(businessDay)">
    ...
    <modal :title="$t('modal.businessDays.addTitle')" :modal-open.sync="isAddModalOpen">
      <business-day-form v-if="isAddModalOpen" @afterModify="isAddModalOpen = false"></business-day-form>
    </modal>

    <modal :title="$t('modal.businessDays.editTitle')" :modal-open.sync="isEditModalOpen">
      <business-day-form v-if="isEditModalOpen" :target-business-day="targetBusinessDay" @afterModify="isEditModalOpen = false"></business-day-form>
    </modal>
    ...
    <confirm-dialog
      ...
      :deleteObject="deleteBusinessDay"
      :objectId="targetBusinessDay.id"
      >
