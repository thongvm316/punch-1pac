<template>
  <main-layout :title="$t('attendances.title')">
    ...
    <table class="table bg-light mt-5">
      ...
      <tbody>
        <tr v-for="attendance in formattedAttendances" :key="attendance.id">
          ...
          <td>
            <button class="btn btn-action btn-link tooltip" :data-tooltip="$t('tooltip.request.add')" @click="toggleAddModal(attendance)">
    ...
    <modal :title="$t('modal.request.addTitle')" :modal-open.sync="isAddModalOpen">
