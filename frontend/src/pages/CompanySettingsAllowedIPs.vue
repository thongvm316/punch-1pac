    ...
    <table class="table bg-light mt-5">
      ...
      <tbody>
        <tr v-for="ip in allowedIPs" :key="ip.id">
          ...
          <td>
            <button class="btn btn-action btn-link tooltip" :data-tooltip="$t('company.allowedIPs.tooltip.edit')" @click="toggleEditModal(ip)">
            ...
            <button class="btn btn-action btn-link tooltip" :data-tooltip="$t('company.allowedIPs.tooltip.delete')" @click="localDeleteIP(ip)">
