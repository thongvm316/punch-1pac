      ...
      <tbody>
        <tr v-for="user in filterUsers(searchText)" :key="user.id" :class="{ 'deactivated': !user.activated }">
          ...
          <td>
            ...
            <button class="btn btn-action btn-link tooltip" :data-tooltip="$t('group.tooltip.deactivateUser')" @click="openConfirmDialog(user)" v-if="$auth('User', currentUser, user).canLockUnlockAccount() && user.activated">
            ...
            <button class="btn btn-action btn-link tooltip" :data-tooltip="$t('group.tooltip.activateUser')" @click="activateGroupUser(user.id)" v-if="$auth('User', currentUser, user).canLockUnlockAccount() && !user.activated">
