      ...
      <tbody>
        <tr v-for="user in group.users" :class="{ 'deactivated': !user.activated }">
          ...
          <td>
            ...
            <button class="btn btn-action btn-link tooltip" :data-tooltip="$t('group.tooltip.deactivateUser')" @click="deactivateGroupUser(user.id)" v-if="user.activated">
            ...
            <button class="btn btn-action btn-link tooltip" :data-tooltip="$t('group.tooltip.activateUser')" @click="activateGroupUser(user.id)" v-if="!user.activated">
            ...
            <button class="btn btn-action btn-link tooltip" :data-tooltip="$t('group.tooltip.removeUser')" @click="removeGroupUser({ groupId: $route.params.id, userId: user.id })" v-if="!user.activated">
