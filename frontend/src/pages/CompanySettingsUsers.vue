      ...
      <tbody>
        <tr v-for="user in filterByEmail(email)">
          ...
          <td>
            ...
            <button class="btn btn-action btn-link tooltip" :data-tooltip="$t('company.users.tooltip.remove')" @click="openConfirmDialog(user)" v-if="$auth('User', currentUser, user).canDelete()">
