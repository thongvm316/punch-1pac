<template>
  <setting-layout sidebar-type="company" :title="$t('company.title')" :subtitle="$t('company.holidays.title')">
    <div class="input-group mt-5">
      ...
      <button ref="importHolidayBtn" class="btn input-group-btn" @click="importHolidays()">{{ $t('company.holidays.btn.import') }}</button>
    </div>
      ...
      <tbody>
        <tr v-for="holiday in filterHolidays(name)" :key="holiday.id">
          ...
          <td>
            ...
            <button class="btn btn-action btn-link tooltip" :data-tooltip="$t('company.holidays.tooltip.delete')" @click="localDeleteHoliday(holiday)">
