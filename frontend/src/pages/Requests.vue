    ...
    <table class="table table-hover bg-light mt-4">
      ...
      <tbody>
        <tr v-for="request in requests">
          ...
          <td>
            <button class="btn btn-action btn-link tooltip" :data-tooltip="$t('requests.tooltip.edit')" @click="toggleEditModal(request)" :disabled="request.status == 'approved'">
            ...
            <button class="btn btn-action btn-link tooltip" :data-tooltip="$t('requests.tooltip.delete')" @click="openConfirmDialog(request)">
