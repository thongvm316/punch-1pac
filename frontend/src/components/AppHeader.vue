      ...
      <div class="navbar">
        ...
        <section class="navbar-section">
          ...
          <div class="dropdown mr-5" :class="{ active: isNotiActive }" @click="toggleNoti">
            <span class="announcement" :class="{ badge: num_announcement }" :data-badge="num_announcement">
            ...
            <div class="panel menu">
              <div class="panel-header">
                <div class="panel-title h4">Announcements</div>
              </div>
              <div class="panel-body" v-show="temp_num === 0">
              ...
              <div class="panel-body" v-show="temp_num > 0">
                <ul class="announcement-items">
                  <router-link to="/announcements/1" class="announcement-item" tag="li">
                    <span>2018-01-26</span>
                    <p class="text-bold">Title 1</p>
                  </router-link>
                  <router-link to="/announcements/1" class="announcement-item" tag="li">
                    <span>2018-01-26</span>
                    <p class="text-bold">Title 1</p>
              ...
              <div class="panel-footer text-center" v-show="temp_num > 0">
...
export default {
  ...
  methods: {
    ...
    toggleNoti () {
      ...
      this.temp_num = this.num_announcement
      this.num_announcement = 0
    }
  },
